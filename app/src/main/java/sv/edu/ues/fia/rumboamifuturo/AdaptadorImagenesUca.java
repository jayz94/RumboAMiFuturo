...
public class AdaptadorImagenesUca extends BaseAdapter {
    private Context context;

    public AdaptadorImagenesUca(Context context) {
        this.context = context;
    }

    @Override
    public int getCount() {
        return Galeria.ItemsUca().length;
    } //modificado solo para Ues con ItemsUes()

    @Override
    public Galeria getItem(int position) {
        return Galeria.ItemsUca()[position];
    } //modificado solo para Ues con ItemsUes()
